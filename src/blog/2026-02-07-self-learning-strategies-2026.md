...
<div class="callout-tip">💡 <strong>핵심 포인트</strong>: 개념 선택</div>
...
<div class="callout-warning">⚠️ <strong>주의사항</strong>: 올인원 생산성 도구. 노트, 데이터베이스, 캘린더를 통합 관리.</div>
...
<div class="callout-info">ℹ️ <strong>참고</strong>: 효과적인 학습은 시간이 아니라 방법입니다. 하루 10시간 공부해도 방법이 잘못되면 소용없고, 하루 1시간이라도 제대로 하면 큰 성과를 냅니다.</div>
